MoveSoundTable:
	...
	db SFX_BATTLE_09,          $79, $c2 ; ASTONISH
	...
	db SFX_VINE_WHIP,          $a1, $f9 ; TWISTER
	...
	db SFX_BATTLE_14,          $88, $10 ; SAND_TOMB
	...
	db SFX_DAMAGE,             $cd, $59 ; ANCIENTPOWER
	...
	db SFX_BATTLE_16,          $ac, $94 ; FLAME_WHEEL
	...
	db SFX_BATTLE_1B,          $2c, $1d ; ROCK_SMASH
	db SFX_BATTLE_1C,          $b8, $a3 ; DYNAMICPUNCH
