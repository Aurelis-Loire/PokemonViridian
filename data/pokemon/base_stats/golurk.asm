	...
	tmhm MEGA_PUNCH,   SHADOW_BALL,  MEGA_KICK,    TOXIC,        ICE_BEAM,     \
	     HYPER_BEAM,   ICE_PUNCH,    DYNAMICPUNCH, POWDER_SNOW,  SOLARBEAM,    \
	     THUNDERBOLT,  EARTHQUAKE,   PSYCHIC_M,    DOUBLE_TEAM,  THUNDERPUNCH, \
		 ROCK_SMASH,   SELFDESTRUCT, FIRE_PUNCH,   MUD_SLAP,     REST,         \
		 ROCK_SLIDE,   SUBSTITUTE,   FLY,          STRENGTH
	; end
