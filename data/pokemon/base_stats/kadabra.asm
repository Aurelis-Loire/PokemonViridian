	...
	tmhm MEGA_PUNCH,   SHADOW_BALL,  MEGA_KICK,    TOXIC,        BODY_SLAM,    \
	     TAKE_DOWN,    DOUBLE_EDGE,  ICE_PUNCH,    SUBMISSION,   DYNAMICPUNCH, \
	     SEISMIC_TOSS, DIG,          PSYCHIC_M,    MIMIC,        DOUBLE_TEAM,  \
	     REFLECT,      THUNDERPUNCH, FIRE_PUNCH,   SKULL_BASH,   HEADBUTT,     \
	     REST,         PSYWAVE,      TRI_ATTACK,   SUBSTITUTE,   THUNDER_WAVE
	; end
