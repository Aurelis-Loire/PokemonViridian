	...
	tmhm MEGA_PUNCH,   MEGA_KICK,    TOXIC,        BODY_SLAM,    TAKE_DOWN,    \
	     DOUBLE_EDGE,  HYPER_BEAM,   DYNAMICPUNCH, SEISMIC_TOSS, THUNDERBOLT,  \
	     THUNDER,      OUTRAGE,      MIMIC,        DOUBLE_TEAM,  REFLECT,      \
	     THUNDERPUNCH, ROCK_SMASH,   FIRE_PUNCH,   SWIFT,        HEADBUTT,     \
