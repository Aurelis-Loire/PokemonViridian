...
; Route 11
	...
	db 18, SLOWPOKE, WOOPER, 0
; Unused
	db 17, SCATTERBUG, BOUNSWEET, BOUNSWEET, SCATTERBUG, 0
...
; Route 24
	db 14, VIVILLON, BUTTERFREE, 0
; Route 6
	db 16, VIVILLON, BEEDRILL, BEEDRILL, 0
	db 20, BUTTERFREE, 0
; Unused
	db 18, METAPOD, CATERPIE, VENONAT, 0
; Route 9
	db 19, VIVILLON, BUTTERFREE, 0
	db 20, BUTTERFREE, BUTTERFREE, VIVILLON, 0
...
; Celadon Gym
	db 24, VULPIX, GASTLY, 0
; Route 13
	db 24, PIDGEY, MEOWTH, BOUNSWEET, PIKACHU, MEOWTH, 0
	db 30, SWANNA, SWANNA, 0
	db 27, PIDGEY, MEOWTH, PIDGEY, PIDGEOTTO, 0
	db 28, GOLDEEN, SWANNA, HORSEA, 0
; Route 20
...
; Route 15
	db 28, AMPHAROS, GARDEVOIR, GARDEVOIR, 0
	db 29, PIKACHU, RAICHU, 0
	db 33, CLEFAIRY, 0
	db 29, BELLSPROUT, GARDEVOIR, KIRLIA, 0
; Route 20
...
BikerData:
; Route 13
	db 28, MILOTIC, MILOTIC, MILOTIC, 0
; Route 14
	db 29, MILOTIC, VIVILLON, 0
; Route 15
	db 25, MILOTIC, MILOTIC, WEEZING, MILOTIC, VIVILLON, 0
	db 28, MILOTIC, VIVILLON, WEEZING, 0
; Route 16
	db 29, VIVILLON, MILOTIC, 0
	db 33, WEEZING, 0
	db 26, VIVILLON, VIVILLON, VIVILLON, VIVILLON, 0
; Route 17
	...
	db 28, WEEZING, MILOTIC, WEEZING, 0
	db 33, MUK, 0
	db 29, VOLTORB, VOLTORB, 0
	db 29, WEEZING, MUK, 0
	db 25, MILOTIC, WEEZING, MILOTIC, MILOTIC, WEEZING, 0
; Route 14
	db 26, MILOTIC, MILOTIC, VIVILLON, MILOTIC, 0
	db 28, VIVILLON, VIVILLON, MILOTIC, 0
	db 29, MILOTIC, MUK, 0
...
; Route 12
	db 22, GOLDEEN, SWANNA, GOLDEEN, 0
	db 24, QUAGSIRE, GOLDEEN, 0
	db 27, GOLDEEN, 0
	db 21, SWANNA, SHELLDER, GOLDEEN, HORSEA, 0
; Route 21
...
CueBallData:
; Route 16
	db 28, CHANSEY, MANKEY, CHANSEY, 0
	db 29, MANKEY, CHANSEY, 0
	db 33, CHANSEY, 0
; Route 17
	db 29, MANKEY, PRIMEAPE, 0
	db 29, CHANSEY, STEENEE, 0
	db 33, STEENEE, 0
	db 26, MANKEY, MANKEY, STEENEE, CHANSEY, 0
	db 29, PRIMEAPE, STEENEE, 0
; Route 21
...
BeautyData:
; Celadon Gym
	db 21, DRIFLOON, DRIFLOON, GASTLY, GOLETT, 0
	db 24, STARYU, STARYU, 0
	db 26, HAUNTER, 0
; Route 13
	db 27, BOUNSWEET, PIKACHU, BOUNSWEET, 0
...
; Route 13
	...
	db 25, SCATTERBUG, PIDGEY, PIDGEY, SCATTERBUG, SCATTERBUG, 0
	db 26, PIDGEY, PIDGEOTTO, SCATTERBUG, MAREEP, 0
; Route 14
	db 33, CHANDELURE, 0
	db 29, SCATTERBUG, MAREEP, 0
; Route 15
	db 26, PIDGEOTTO, CHANDELURE, DODUO, PIDGEY, 0
	db 28, DODRIO, DODUO, DODUO, 0
; Route 18
	db 29, SCATTERBUG, MAREEP, 0
	db 34, DODRIO, 0
	db 26, SCATTERBUG, SCATTERBUG, MAREEP, SCATTERBUG, 0
; Route 20
...
; Route 14
	...
	db 26, PIDGEY, SCATTERBUG, PIDGEY, MAREEP, 0
	db 29, PIDGEOTTO, MAREEP, 0
	db 28, SCATTERBUG, DODUO, MAREEP, 0
...
Green1Data:
	...
	db 5, CHARMANDER, 0
; Route 22
	db $FF, 9, MANKEY, 8, SQUIRTLE, 0
	db $FF, 9, MANKEY, 8, BULBASAUR, 0
	db $FF, 9, MANKEY, 8, CHARMANDER, 0
; Cerulean City
	db $FF, 18, RALTS, 15, MANKEY, 15, FLAAFFY, 17, WARTORTLE, 0
	db $FF, 18, RALTS, 15, MANKEY, 15, FLAAFFY, 17, IVYSAUR, 0
	db $FF, 18, RALTS, 15, MANKEY, 15, FLAAFFY, 17, CHARMELEON, 0
...
; Silph Co. 2F
	db 26, VIVILLON, WEEZING, MILOTIC, WEEZING, 0
...
; Viridian Gym
	db $FF, 45, RHYHORN, 42, DUGTRIO, 44, FRIGIBAX, 45, SPEWPA, 50, RHYDON, 0
...
; Rocket Hideout B1F
	...
	db 20, CUBONE, SALANDIT, SALANDIT, 0
	db 19, CROAGUNK, CROAGUNK, MEOWTH, WAILMER, 0
	db 22, CUBONE, SALANDIT, 0
; Rocket Hideout B2F
	db 17, ZUBAT, SALANDIT, WAILMER, ZUBAT, WAILMER, 0
; Rocket Hideout B3F
...
; Silph Co. 9F
	db 28, JOLTIK, VIVILLON, CHANSEY, 0
...
CooltrainerFData:
; Celadon Gym
	db 24, GOLBAT, DRIFLOON, CROAGUNK, 0
; Victory Road 3F
...
Green2Data:
; SS Anne 2F
	db $FF, 19, RALTS, 16, MANKEY, 18, FLAAFFY, 20, WARTORTLE, 0
	db $FF, 19, RALTS, 16, MANKEY, 18, FLAAFFY, 20, IVYSAUR, 0
	db $FF, 19, RALTS, 16, MANKEY, 18, FLAAFFY, 20, CHARMELEON, 0
; Pokémon Tower 2F
