...
; Route 21
	db 31, QUAGSIRE, QUAGSIRE, LANDORUS, 0
...
; Victory Road 3F
	db 43, GARCHOMP, MAMOSWINE, GALVANTULA, 0
	db 43, MILTANK, ARMALDO, CHANSEY, 0
; Unused
...
LoreleiData:
	db $FF, 54, ARMALDO, 53, CLOYSTER, 54, SLOWBRO, 56, SALAZZLE, 56, LAPRAS, 0
