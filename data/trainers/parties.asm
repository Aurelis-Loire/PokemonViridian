...
; Route 8
	db 23, WOOPER, NIDORINA, 0
	db 24, MEOWTH, MEOWTH, MEOWTH, 0
	db 19, PIDGEY, BOUNSWEET, SKWOVET, MEOWTH, PIKACHU, 0
...
; Route 8
	db 20, VOLTORB, MILOTIC, VOLTORB, MAGNEMITE, 0
...
; Rocket Hideout B1F
	...
	db 20, VIVILLON, MILOTIC, MILOTIC, 0
	db 19, BOUNSWEET, DUCKLETT, DUCKLETT, BOUNSWEET, 0
	db 22, VIVILLON, MILOTIC, 0
; Rocket Hideout B2F
	db 17, ZUBAT, MILOTIC, VIVILLON, ZUBAT, DUCKLETT, 0
; Rocket Hideout B3F
