...
ViridianCashierText::
	script_mart POKE_BALL, ANTIDOTE, PARLYZ_HEAL, BURN_HEAL, TM_MUD_SLAP

PewterCashierText::
	script_mart POKE_BALL, POTION, ESCAPE_ROPE, ANTIDOTE, ICE_HEAL, AWAKENING, PARLYZ_HEAL, TM_ROCK_SMASH
