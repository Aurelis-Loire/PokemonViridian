...
ViridianCashierText::
	script_mart POKE_BALL, ANTIDOTE, PARLYZ_HEAL, BURN_HEAL, TM_DREAM_EATER

PewterCashierText::
	script_mart POKE_BALL, POTION, ESCAPE_ROPE, ANTIDOTE, ICE_HEAL, AWAKENING, PARLYZ_HEAL, TM_WATER_GUN

CeruleanCashierText::
	script_mart POKE_BALL, POTION, REPEL, ANTIDOTE, BURN_HEAL, AWAKENING, PARLYZ_HEAL, TM_THUNDER_WAVE
...
CeladonMart2Clerk2Text::
	script_mart TM_DOUBLE_TEAM, TM_REFLECT, TM_RAZOR_WIND, TM_HEADBUTT, TM_WATER_GUN, TM_MEGA_PUNCH, TM_MEGA_KICK, TM_TAKE_DOWN, TM_SUBMISSION
...
IndigoCashierText::
	script_mart ULTRA_BALL, GREAT_BALL, FULL_RESTORE, MAX_POTION, FULL_HEAL, REVIVE, MAX_REPEL, TM_PSYCHIC_M
