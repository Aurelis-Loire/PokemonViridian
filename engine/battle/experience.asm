...
.next2
	...
	ld [wTempCoins1], a	;implemented in shinpokered; joenote - fixing skip move-learn glitch: need to store the current level in wram
	cp d
...
.printGrewLevelText
	...
	ld a, [wd0b5]
	ld [wd11e], a
	;Implemented in shinpokered; joenote - fixing skip move-learn glitch: here is where moves are learned from level-up, but it needs some changes
