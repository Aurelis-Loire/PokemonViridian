...
SpewpaPicFront::      INCBIN "gfx/pokemon/front/spewpa.pic"
SpewpaPicBack::       INCBIN "gfx/pokemon/back/spewpab.pic"
...
VivillonPicFront::    INCBIN "gfx/pokemon/front/vivillon.pic"
VivillonPicBack::     INCBIN "gfx/pokemon/back/vivillonb.pic"
